...
#define DM_P_MIN -6.2831f		//位置最小值
#define DM_P_MAX 6.2831f		//位置最大值
#define DM_V_MIN -15			//速度最小值
#define DM_V_MAX 15			//速度最大值
...
#define DM_KP_MAX 500	//Kp最大值,目前根据上位机控制设置中读取的值设定,实际mit模式下位置和速度基本不起作用,主要为力矩T
